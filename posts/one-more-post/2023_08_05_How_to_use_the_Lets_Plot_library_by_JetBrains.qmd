...
# Table of contents
- [Syntax Similarities: Lets-Plot and ggplot2](#id-section1)
- [Visualizing Data Based on Categorical Variables](#id-section2)
- [Incorporate Multiple Variables with facet_wrap](#id-section3)
- [Reordering Categorical Variables Based On Statistics](#id-section4)
- [Chaining Pandas Code with Lets Plot Visualization](#id-section5)
...
```{python}
g=(ggplot(df, aes(x = 'flipper_length_mm', y = 'body_mass_g'))  
...
ggsave(g, filename='2023_08_05_4.svg')
```
